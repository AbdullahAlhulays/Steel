  ...
  return (
    <section id="products" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        ...
        {hasFilters && (
          <button
            ...
            className="w-fit rounded-2xl border border-[#D6D1CA] bg-white px-5 py-3 text-sm font-bold text-[#2F2F2F] shadow-sm transition hover:border-[#AEB4BC] hover:bg-[#F3EEE7]"
          >
            عرض كل المنتجات
          </button>
        )}
      ...
      {products.length > 0 ? (
        ...
        <div className="rounded-3xl border border-[#D6D1CA] bg-white p-10 text-center shadow-sm">
